...
namespace Robust.Shared
{
    ...
    public abstract class CVars
    {
        ...
        public static readonly CVarDef<string> GameHostName =
            CVarDef.Create("game.hostname", "NES14 - Main [BETA]", CVar.ARCHIVE | CVar.REPLICATED | CVar.SERVER);

        /// <summary>
        /// Description of the game server in the launcher.
        /// </summary>
        public static readonly CVarDef<string> GameDesc =
            CVarDef.Create("game.desc", "Бета сервер Not Endless Station", CVar.SERVERONLY);
