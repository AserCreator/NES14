...
ent-PosterContrabandFunPolice = Голожопые мартышки менты
    .desc = Плакат с критикой службы безопасности станции.
ent-PosterContrabandLustyExomorph = Похотливая Ксено дева
    .desc = Вульгарный плакат, такой-же вульгарной книги.
ent-PosterContrabandSyndicateRecruitment = "Прекрасная" земля
    .desc = Земля из-за Федерации сегодня, вступи в ОПЗ и положи этому конец!
...
ent-PosterContrabandRebelsUnite = Мятежники объединяйтесь
    .desc = Плакат, призывающий читателя восстать против Космической Торговой Компании.
...
ent-PosterLegitNanotrasenLogo = Флаг Федерации
    .desc = Плакат с флагом Федерации. В былое время были споры о том что-бы поменять флаг на более солидный, однако, двухглавый орел уже приелся.
ent-PosterLegitVulpaBluat = Похотливая Ахерианская дева
    .desc = Плакат с красивой Ахерианкой, на заднем плане неоновый фон. Над всем этим надпись "в дормы?". Это пиздец сука.
...
ent-PosterLegitNoERP = Скажи "нет" Порнографии!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография не преветствуется и пресекается всеми государствами солнечной системы, а ксено-эротика может обойтись вам казнью.
