...
ent-ClothingUniformJumpsuitCaptain = комбинезон администратора
    .desc = Синий комбинезон с золотыми нашивками, указывающими на звание администратора.
...
ent-ClothingUniformJumpsuitHoP = комбинезон менеджера станции
...
ent-ClothingUniformJumpsuitCapFormal = торжественный костюм администратора
