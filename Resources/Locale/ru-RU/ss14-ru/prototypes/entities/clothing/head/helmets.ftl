...
ent-ClothingHeadHelmetSwat = шлем спецназа
    .desc = Очень прочный шлем, широко используемый военизированными организациями. На его верхней части выгравирован двухглавый орел.
...
ent-ClothingHeadHelmetERTLeader = шлем лидера ОБР
    .desc = Атмосферный шлем, который носят лидеры отрядов быстрого реагирования. Имеет голубой фонарь.
ent-ClothingHeadHelmetERTSecurity = шлем офицера безопасности ОБР
    .desc = Атмосферный шлем, который носят офицеры безопасности отрядов быстрого реагирования. Имеет красный фонарь.
ent-ClothingHeadHelmetERTMedic = шлем медика ОБР
    .desc = Атмосферный шлем, который носят медики отрядов быстрого реагирования. Имеет белый фонарь.
ent-ClothingHeadHelmetERTEngineer = шлем инженера ОБР
    .desc = Атмосферный шлем, который носят инженеры отрядов быстрого реагирования. Имеет оранжевый фонарь.
ent-ClothingHeadHelmetERTJanitor = шлем уборщика ОБР
    .desc = Атмосферный шлем, который носят уборщики отрядов быстрого реагирования. Имеет тёмно-фиолетовый фонарь.
ent-ClothingHeadHelmetProtogen = робо-маска
    .desc = Атмосферный шлем-маска, который носят либо IT гении, либо извращенцы.
