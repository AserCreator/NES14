ent-ClothingNeckCloakCap = плащ администратора
...
ent-ClothingNeckCloakHop = плащ менеджера станции
...
ent-ClothingNeckCloakCapFormal = торжественный плащ администратора
...
ent-ClothingNeckCloakPirateCap = плащ администратора пиратов
