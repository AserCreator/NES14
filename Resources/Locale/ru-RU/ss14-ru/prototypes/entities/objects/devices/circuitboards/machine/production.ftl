...
ent-BorgChargerCircuitboard = станция зарядки дронов (машинная плата)
    .desc = Печатная плата станции зарядки дронов.
...
ent-Printer = Принтер
    .desc = Ограниченая версия принтеров Index Dunamix, с ограниченым функционалом.
ent-PrinterRestock = Печатная бумага
    .desc = Бумага для печатей документов.
