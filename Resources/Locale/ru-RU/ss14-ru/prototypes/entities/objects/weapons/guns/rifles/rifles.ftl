...
ent-WeaponRifleLecter = Лектер
    ...
    .suffix = Автомат
ent-WeaponRifleCrossvec = Кросс-VEC
    .desc = Элитный автомат со складным прикладом, использовался элитными военными подразделениями до 2128 года. Использует патроны калибра .20 JHP.
    .suffix = Автомат
