...
ent-PaperCaptainsThoughts = размышления Админитсратора
    .desc = Страница из дневника Админитсратора. В роскошном лавандовом цвете.
...
ent-PenCap = перьевая ручка Админитсратора
    .desc = Элегантная перьевая ручка для Админитсратора станции.
...
ent-RubberStampCaptain = печать Админитсратора
    .desc = { ent-RubberStampBase.desc }
    .suffix = НЕ МАППИТЬ
