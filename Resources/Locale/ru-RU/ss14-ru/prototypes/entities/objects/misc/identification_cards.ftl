...
ent-PassengerIDCard = ID карта туриста
...
ent-ServiceWorkerIDCard = ID карта обслуживающего персонала
    .desc = { ent-PassengerIDCard.desc }
ent-CaptainIDCard = ID карта администратора
    .desc = { ent-IDCardStandard.desc }
...
ent-LawyerIDCard = ID карта адвоката
    .desc = { ent-IDCardStandard.desc }
ent-HoPIDCard = ID карта менеджера станции
    .desc = { ent-IDCardStandard.desc }
...
ent-AgentIDCard = { ent-PassengerIDCard }
    .suffix = Агентская
    .desc = { ent-PassengerIDCard.desc }
ent-NukieAgentIDCard = ID карта туриста
    .suffix = Оперативники
