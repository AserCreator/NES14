ent-Hypospray = спец. гипоспрей
    .desc = Экспериментальный стерильный пистолет-инъектор для быстрого введения лекарств пациентам.
ent-paramed_hypospray = пистолет-инъектор
    .desc = Стандартный пистолет-инъектор для высокопоставленых врачей.
ent-SyndiHypo = UKO гипоспрей
    .desc = Боевой пистолет-инъектор, сбоку написано что UKO уверена в качестве своего продукта и предоставляет гарантию на 5 лет.
