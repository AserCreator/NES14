...
ent-ClothingOuterCoatCaptain = торжественная куртка администратора
    .desc = администраторская торжественная куртка, инкрустированная золотом.
ent-ClothingOuterCoatHOP = куртка менеджера станции
    .desc = Деловая куртка менеджера станции для создания профессионального вида.
